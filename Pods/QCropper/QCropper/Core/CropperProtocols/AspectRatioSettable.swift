...
extension AspectRatioSettable where Self: CropperViewController {
    ...
    public func setCircularCrop(_ aspectRatioValue: CGFloat) {
        ...
        matchScrollViewAndCropView(animated: true, targetCropBoxFrame: cropBoxFrame, blurLayerAnimated: true, animations: nil, completion: {
